...
<body>
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li><a href="PatientApp.aspx">Book Appointment</a></li> 
                      </ul>        
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
                  <h2>Rushikesh Mote <em>Clinic</em> for your business<br>&amp; upgrade <em>all aspects</em></h2>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2025 Rushikesh Mote., Ltd. All Rights Reserved. 
          
          <br>Designed by <a title="CSS Templates" rel="sponsored" >Rm8_rushi</a></p>
        </div>
      </div>
    </div>
  </footer>
